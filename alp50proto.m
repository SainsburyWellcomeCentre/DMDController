function [methodinfo,structs,enuminfo,ThunkLibName]=alp50proto
%ALP50PROTO Create structures to define interfaces found in 'alp'.

%This function was generated by loadlibrary.m parser version  on Mon Mar  9 13:47:23 2026
%perl options:'alp.i -outfile=alp50proto.m -thunkfile=alp50_thunk_pcwin64.c -header=alp.h '
ival={cell(1,0)}; % change 0 to the actual number of functions to preallocate the data.
structs=[];enuminfo=[];fcnNum=1;
fcns=struct('name',ival,'calltype',ival,'LHS',ival,'RHS',ival,'alias',ival,'thunkname', ival);
MfilePath=fileparts(mfilename('fullpath'));
ThunkLibName=fullfile(MfilePath,'alp50_thunk_pcwin64');
...
%  long AlpSeqPutEx ( ALP_ID DeviceId , ALP_ID SequenceId , void * UserStructPtr , void * UserArrayPtr ); 
fcns.thunkname{fcnNum}='longulongulongvoidPtrvoidPtrThunk';fcns.name{fcnNum}='AlpSeqPutEx'; fcns.calltype{fcnNum}='Thunk'; fcns.LHS{fcnNum}='long'; fcns.RHS{fcnNum}={'ulong', 'ulong', 'voidPtr', 'voidPtr'};fcnNum=fcnNum+1;
...
structs.tAlpLinePut.packing=1;
structs.tAlpLinePut.members=struct('TransferMode', 'long', 'PicOffset', 'long', 'PicLoad', 'long', 'LineOffset', 'long', 'LineLoad', 'long');
structs.tFlutWrite.packing=1;
structs.tFlutWrite.members=struct('nOffset', 'long', 'nSize', 'long', 'FrameNumbers', 'ulong#4096');
structs.tAlpShearTable.packing=1;
structs.tAlpShearTable.members=struct('nOffset', 'long', 'nSize', 'long', 'nShiftDistance', 'long#8192');
structs.tAlpDmdMask16K.packing=1;
structs.tAlpDmdMask16K.members=struct('nBlockWidth', 'long', 'nRowOffset', 'long', 'nRowCount', 'long', 'Bitmap', 'uint8#16384');
structs.tAlpDmdMask.packing=1;
structs.tAlpDmdMask.members=struct('nRowOffset', 'long', 'nRowCount', 'long', 'Bitmap', 'uint8#2048');
structs.tBplutWrite.packing=1;
structs.tBplutWrite.members=struct('nOffset', 'long', 'nSize', 'long', 'BitPlanes', 'uint16#2048');
